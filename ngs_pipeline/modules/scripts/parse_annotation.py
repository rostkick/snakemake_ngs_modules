...
# input_file = 'results/2025_02_14_LQTS/germline/tsv/LQTS_258_grm.unfiltered.tsv'
mart_file = snakemake.params.mart
# mart_file = '/ngs_pipeline/app/ngs_refs/VEP_plugins/custom_anno/mart_export.tsv'
...
def main():
	...
	df.drop(['AD1', 'AD2', 'AlleleBalance', 'Consequence_severity',
			...
			'Gene name', 'BIOTYPE', 'CANONICAL', 'Gene stable ID'], axis=1, inplace=True)
